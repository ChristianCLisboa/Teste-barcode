		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cdbcodigodebarra-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cdbcodigodebarra-display": {
								"semanticObject": "cdbcodigodebarra",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cdb.codigodebarra",
									"url": sap.ui.require.toUrl("cdb/codigodebarra")
								}
							}
						}
					}
